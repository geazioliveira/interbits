...
@section('content')
    ...
    <form method="POST" action="/register/add">
            ...
            <div class="controls">
                <select name="function_id" id="function">
                    ...
                    @foreach($functions as $function)
                        @if(old('function_id') == $function->id)
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="number" name="ddd" id="ddd" min="0" max="99" placeholder="Ex. 11" value="{!! old('ddd') !!}">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="number" name="phone" id="phone" min="0" max="999999999" placeholder="Ex. 960768689" value="{!! old('phone') !!}">
            </div>
        </div>
